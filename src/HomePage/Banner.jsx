                        ...
                        <div className="hero h-full absolute left-0 top-0 bg-black bg-opacity-80" >
                            <div className="hero-content text-center mb-36">
                                <div className="flex flex-col h-[60vh] justify-center">
                                    <h1 data-aos="fade-right" className="text-2xl md:text-5xl text-white font-bold">Welcome to <span className="text-[#43ba7f]">FestiveFusion</span>: Your Cultural Celebration Expert</h1>
                                    <div className='mt-10'>
                                        <p data-aos="fade-left" className=" text-gray-200">At FestiveFusion, we specialize in crafting unforgettable cultural celebrations that blend tradition and innovation. Let us bring your cultural dreams to life.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <SwiperSlide>
                    <div className='relative'>
                        ...
                        <div className="hero h-full absolute left-0 top-0 bg-black bg-opacity-80" >
                            <div className="hero-content text-center mb-36">
                                <div className="flex flex-col h-[60vh] justify-center">
                                    <h1 data-aos="fade-right" className="text-2xl md:text-5xl text-white font-bold">Expert <span className="text-[#43ba7f]">Cultural Event</span> Planning or Customized Cultural Experiences</h1>
                                    <div className='mt-10'>
                ...
                <SwiperSlide>
                    <div className='relative'>
                        ...
                        <div className="hero h-full absolute left-0 top-0 bg-black bg-opacity-80" >
                            <div className="hero-content text-center mb-36">
                                <div className="flex flex-col h-[60vh] justify-center">
                                    <h1 data-aos="fade-right" className="text-2xl md:text-5xl text-white font-bold">Celebrating Culture: Experts in <span className="text-[#43ba7f]">Memorable Events</span></h1>
                                    <div className='mt-10'>
